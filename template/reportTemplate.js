...
export const reportTemplate = (user, enquiries, statusCounts) => {
...
<html dir="ltr" lang="en">
  ...
  >
                ...
                <tr>
                  <td>
                    ...
                    >
                     ...
                     <h2 style="text-align: center; color: #333;">Daily Enquiry Report</h2>
    <p style="text-align: center; color: #555;">Date: ${today.format(
			'YYYY-MM-DD'
		)}</p>
    <p style="font-size: 16px; line-height: 1.5;">Hello, ${
			user.userName
		}. Here is your daily report on enquiries:</p>
    ...
    <ul style="list-style: none; padding: 0;">
      ...
      <li><strong>Hold:</strong> ${statusCounts.hold}</li>
    </ul>
                            <h3>Detail Enquiry Report</h3>
